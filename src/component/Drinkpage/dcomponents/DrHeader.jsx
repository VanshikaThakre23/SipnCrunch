...
const DrHeader = () => {
  ...
  return (
    <header className="header">
        ...
        >
          <SwiperSlide>
            <div className="swiper-slide">
              <div className="text-content">
                ...
                <h3>Cookie Monster Shake</h3>
                <button type="submit" className="swiper-text-btn">Order Now</button>
              </div>
              <img className="hover-img" src="/assets/drink-images/Cookie Monster Shake.png" alt="Spicy Fried Chicken" />
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="swiper-slide">
              ...
              <img className="hover-img" src="/assets/drink-images/s_4.webp" alt="Spicy Fried Noodles" />
            </div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div className="swiper-slide">
              <div className="text-content">
                <h2>WELCOME TO SIPNCRUNCH</h2>
                <h3>Mix fruit juice</h3>
                <button type="submit" className="swiper-text-btn">Order Now</button>
              </div>
              <img className="hover-img" src="/assets/drink-images/head1.png" alt="Spicy Fried Pasta" />
            </div>
          </SwiperSlide>
        </Swiper>
      </div>
      ...
      <img className="mainshape1" src="/assets/drink-images/head3.png" alt="Chilli" />
      {/* <img className="mainshape2" src="/assets/food-images/ONIONSLICE.avif" alt="Onion Slice" /> */}
      <img className="mainshape3" src="/assets/drink-images/leaf-1.png" alt="Shape 2" />
